...
function getPoints(p0, p1, p2, p3) {

  for (let i = 0; i <= numberOfPoints; i++) {
    const t = i / numberOfPoints;
    const point = bezierCurve(t, p0, p1, p2, p3);
    curvePoints.push(point);
  }

  // Now, curvePoints contains the (x, y) coordinates of points along the Bezier curve.
